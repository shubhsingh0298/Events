...
class RawEventsTesting(EventAutomation):
    ...
    def eve_22_pd(self, url):
        ...
        self.finds_elements('//*[@id="eve_22"]/li[3]/a/span')
    ...
    def eve_22_mother(self, url):
        self.request_func(url)
        element = self.finds_elements('//*[@id="eve_22"]/div/ul/li[4]/a')
        if element:
            element.click()
        self.print_visitor_id()
        con = "BPN"
    ...
    def eve_22_category(self, url):
        self.request_func(url)
        self.reload()
        self.finds_elements('//*[@id="eve_22"]/div/ul/li[3]/a/span')
        self.print_visitor_id()
        con = "BPN"
        val1 = ''
        val2 = ''
    ...
    def eve_22_brand(self, url):
        self.request_func(url)
        self.reload()
        self.finds_elements('//*[@id="eve_22"]/li[2]/a/span')
        self.print_visitor_id()
        con = "BPN"
        val1 = ''
        val2 = ''
    ...
    def eve_22_l1(self, url):
        self.request_func(url)
        self.reload()
        self.finds_elements('//*[@id="eve_22"]/div/ul/li[1]/a/span')
        self.print_visitor_id()
        con = "BPN"
        val1 = ''
        val2 = ''
    ...
    def eve_22_l2(self, url):
        self.request_func(url)
        self.finds_elements('//*[@id="eve_22"]/div/ul/li[2]/a/span')
        self.print_visitor_id()
        con = "BPN"
        val1 = ''
        val2 = ''
    ...
    def eve_28_default(self, url):
        self.request_func(url)
        brand_name_locator = '//*[@id="eve_28"]'  # 28
        self.finds_elements(brand_name_locator)
        self.print_visitor_id()
        con = "BPN"
        val1 = ''
        val2 = ''
    ...
    def eve_93_p(self, url):
        self.request_func(url)
        explore_more = '/html/body/section[5]/div[2]/ul/li[8]/a'
        self.finds_elements(explore_more)
        self.print_visitor_id()
        con = "BPN"
        val1 = 'name'
    ...
    def eve_93_pd(self, url):
        self.request_func(url)
        explore_more = '/html/body/section[7]/div[2]/ul/li[8]/a'
        self.finds_elements(explore_more)
        self.print_visitor_id()
        con = "BPN"
        val1 = 'name'
    ...
    def eve_93_b(self, url):
        self.request_func(url)
        explore_more = '/html/body/section[7]/div[1]/ul/li[8]/a'
        self.finds_elements(explore_more)
        self.print_visitor_id()
        con = "BPN"
        val1 = 'name'
    ...
    def eve_72_fastener_listtview(self, url):
        self.request_func(url)
        self.finds_elements('//*[@id="listViewSwitch"]/span/i')
    ...
    def eve_72_fastener_gridview(self, url):
        self.request_func(url)
        self.finds_elements('//*[@id="gridViewSwitch"]/span/i')
        self.finds_elements('/html/body/div[4]/div/div[2]/div/div[5]/div[2]/div[2]/div/div[2]/div[3]')
        self.back()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#mothertitle'
    ...
    def eve_103_nonfastener_defaultview(self, url):
        self.request_func(url)
        default_view_switch_elements = self.page.query_selector_all('//*[@id="defaultViewSwitch"]')
        add_cart_elements = self.page.query_selector_all('//*[@class="add_cart caterfq"]')
        self.print_visitor_id()
        con = "BP"
        val1 = '#Product Title '
        val2 = 'View name'
    ...
    def eve_109_fastener_listtview(self, url):
        ...
        self.finds_elements(comment)
        self.finds_elements('/html/body/div[4]/div/div[2]/div/div[5]/div[2]/div[3]/div/div[2]/div[2]/div[1]/div/h3/a')
    ...
    def eve_109_fastener_gridview(self, url):
        ...
        self.finds_elements(comment)
        self.finds_elements('/html/body/div[4]/div/div[2]/div/div[5]/div[2]/div[7]/div/div[2]/div[2]/div[1]/div/h3/a')
        self.print_visitor_id()
        con = "BPN"
        val1 = '#Product Title'
        val2 = 'View name '
    ...
    def eve_66_L2(self, url):
        self.request_func(url)
        self.chat_box_close()
        comment = '//*[@id="at_cat"]/div/button/i'
        self.finds_elements(comment, 'vestil')
        pyautogui.press('enter')
        # self.finds_elements('//*[@id="eve_284"]')
        # self.finds_elements(comment)
    ...
    def eve_66_mother(self, url):
        self.request_func(url)
        self.chat_box_close()
        comment = '//*[@id="at_24183"]/div/button/i'
        self.finds_elements(comment, '42')
        pyautogui.press('enter')
        # self.finds_elements('//*[@id="eve_284"]')
        # self.finds_elements(comment)
        self.print_visitor_id()
    ...
    def eve_114_fasteners_default(self, url):
        ...
        self.finds_elements('//*[@class="cart_box_btn atc_Fastener"]')
        self.print_visitor_id()
        con = "BP"
        val1 = '#quantity | Title'
        val2 = 'View name'
    ...
    def eve_300_home(self, url):
        ...
        self.finds_elements('//*[@id="eve_300"]/div/div[1]/a[1]')
        self.print_visitor_id()
        con = "BPN"
        val1 = '#cat name'
        val2 = ''
    ...
    def eve_303_home(self, url):
        ...
        self.finds_elements('//*[@id="eve_303"]/div[1]/a[1]')
        self.print_visitor_id()
        con = "BPN"
        val1 = '#brand name'
        val2 = ''
    ...
    def eve_306_home(self, url):
        ...
        self.chat_box_close()
        time.sleep(4)
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Germany')
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("Deutsch").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_l2(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value="Romania")
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("Română").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_brand(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.finds_elements('#top_country_list', 'Itlay')
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("Italiano").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_mother(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Spain')
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("Español").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_grainger(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Vietnam')
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("Tiếng Việt").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_l3(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Thailand')
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("ภาษาไทย").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_desktop(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='France')
        self.finds_elements('//*[@id="eve_12"]')
        self.finds_elements('//*[@id="countryImageFlag"]')
        self.page.get_by_text("Français").click()
        self.print_visitor_id()
        con = "BPN"
        val1 = '#lang name'
        val2 = 'url'
    ...
    def eve_306_myaccount(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Itlay')
        self.finds_elements('//*[@id="eve_12"]')
        self.page.get_by_text("Italiano").click()
    ...
    def eve_225_l2(self, url):
        ...
        self.driver.execute_script('document.querySelector("#at_brand").click()')
    ...
    def eve_225_l3(self, url):
        ...
        time.sleep(2)
        # self.finds_elements('//*[@id="at_23339"]/span[2]') 
        self.driver.execute_script('document.querySelector("#at_31154").click()')
        # self.finds_elements('//*[@class="fileter-inner"]/label/span')
        # self.finds_elements('//*[@id="at_brand"]')
    ...
    def eve_402_mobile_pd(self, url):
        self.mobile_screen_request(url)
        self.finds_elements('//*[@id="eve_39"]')
        self.finds_elements('//*[@id="eve_402"]')
        self.print_visitor_id()
        con = "BP"
        val1 = ''
    ...
    def eve_12_home(self, url):
        self.request_func(url)
        self.chat_box_close()
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/a//*[name()="svg"]')
        self.finds_elements('//*[@class="country-change"]')
        self.page.select_option('#top_country_list', value="United Kingdom")
        self.finds_elements('//*[@id="eve_12"]')
        self.print_visitor_id()
        con = "BP"
        val1 = ''
    ...
    def eve_12_l2(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Uganda')
        time.sleep(2)
        self.finds_elements('//*[@id="eve_12"]')
        self.print_visitor_id()
        con = "BP"
    ...
    def eve_12_brand(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Togo')
        time.sleep(2)
        self.finds_elements('//*[@id="eve_12"]')
        # self.chat_box_close()
    ...
    def eve_12_mother(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value= 'Austria')
        time.sleep(2)
        self.finds_elements('//*[@id="eve_12"]')
        self.print_visitor_id()
        con = "BP"
    ...
    def eve_12_grainger(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        # self.finds_elements('//*[@class="country-change"]')
        self.page.select_option('#top_country_list', value='Benin')
        time.sleep(2)
        self.finds_elements('//*[@id="eve_12"]')
        self.print_visitor_id()
        con = "BP"
    ...
    def eve_12_desktop_pd(self, url):
        ...
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]//*[name()="svg"]')
        self.finds_elements('//*[@id="myHeader"]/div[1]/div[3]/ul/li[1]/div/div[4]')
        self.page.select_option('#top_country_list', value='Iraq')
        time.sleep(2)
        self.finds_elements('//*[@id="eve_12"]')
        # self.chat_box_close()
        # self.finds_elements('//*[@class="submenu"]/li[3]')
...
def run_program():
    ...
    program_dict = {
        ...
        'eve_98_brandlist': 'eve_98_brandlist("https://www.raptorsupplies.com/b/l")',
        ...
        'eve_100_brandlist': 'eve_100_brandlist("https://www.raptorsupplies.com/b/l")',
        ...
        'eve_299_brand': 'eve_299_brand("https://www.raptorsupplies.com/b")',
        ...
        'eve_300_brand': 'eve_300_brand("https://www.raptorsupplies.com/b")',
        ...
        'eve_306_l1': 'eve_306_l1("https://www.raptorsupplies.com/l1/abrasives")',
        ...
        'eve_402_l3_grid': 'eve_402_l3_grid("https://www.raptorsupplies.com/c/microwave-ovens")',
        'eve_402_l3_list': 'eve_402_l3_list("https://www.raptorsupplies.com/c/microwave-ovens")',
        ...
        'eve_402_mobile_pd': 'eve_402_mobile_pd("https://www.raptorsupplies.com/pd/burndy/pena13qt")',
        ...
        'eve_6_brand': 'eve_6_brand("https://www.raptorsupplies.com/b/3m")',
        'eve_6_mother': 'eve_6_mother("https://www.raptorsupplies.com/p/ps-doors/ladder-safety-gate-adapter-brackets")',
        ...
        # 'eve_6_product_mobile': 'eve_6_product_mobile("https://www.raptorsupplies.com/pd/dap/70798-08642")',
        ...
        # 'eve_7_product_mobile': 'eve_7_product_mobile("https://www.raptorsupplies.com/pd/dap/70798-08642")',
        ...
        # 'eve_8_product_mobile': 'eve_8_product_mobile("https://www.raptorsupplies.com/pd/dap/70798-08642")',
        ...
        # 'eve_5_product_mobile': 'eve_5_product_mobile("https://www.raptorsupplies.com/pd/dap/70798-08642")',
...
# keys_to_run=["eve_103_nonfastener_listtview","eve_103_nonfastener_gridview","eve_103_nonfastener_defaultview","eve_103_fastener_defaultview"]
keys_to_run=["eve_90_brand"]
run_program()
